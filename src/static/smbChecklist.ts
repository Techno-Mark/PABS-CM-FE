...
export const validateSmbPeopleBusinessField = [
  "ClientNameStatus",
  "ClientNameDetails",
  "ClientNameActionItems",
  "PocStatus",
...
export const validateSmbMeetingField = [
  "TimeZoneStatus",
  "TimeZoneDetails",
  "TimeZoneActionItems",
  "ConvenientStatus",
...
export const fieldDisplayNamesSmbBankingAccess: { [key: string]: string } = {
  ...
  SavingAccountDetails: "Information",
  SavingAccountActionItems: "Action Items",
  AddCardsStatus: "Status",
  AddCardsDetails: "Information",
