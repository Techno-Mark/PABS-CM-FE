...
export const fieldDisplayNamesSmbExistingFinancials: { [key: string]: string } =
  {
    ...
    AccountingMethodStatus: "Status",
    AccountingMethodDetails: "Details",
    AccountingMethodActionItems: "Action Items",
    FEINStatus: "Status",
    FEINDetails: "Details",
    FEINActionItems: "Action Items",
    FiscalYearEndStatus: "Status",
    FiscalYearEndDetails: "Details",
    FiscalYearEndActionItems: "Action Items",
    LastClosedMonthStatus: "Status",
    LastClosedMonthDetails: "Details",
    LastClosedMonthActionItems: "Action Items",
    ContactOfCpaStatus: "Status",
    ContactOfCpaDetails: "Details",
    ContactOfCpaActionItems: "Action Items",
