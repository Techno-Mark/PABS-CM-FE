...
export const fieldDisplayNamesWhiteLabelchecklist: { [key: string]: string } = {
  Status: "Status",
  Comments: "Comments",
  ActionPABS: "ActionPABS",
  ActionClient: "ActionClient",
};

export const validateWhiteLabelSystemSoftwareField = [
  "accountingSoftwareWhiteLabelStatus",
  "accountingSoftwareWhiteLabelComments",
  "accountingSoftwareWhiteLabelActionPABS",
  "accountingSoftwareWhiteLabelActionClient",
...
export const fieldDisplayNamesWhiteLabelSystemSoftware: {
  [key: string]: string;
} = {
...
export const AccordianExpand = {
  ...
  SERVICE_TYPE: 3,
  CHALLENGES_EXPECTATION: 4,
  TYPE_OF_WORK_ASSIGNMENT: 5,
  ESCALATION_MATRIX: 6,
  MEETING_AVAILABILITY: 7,
};
